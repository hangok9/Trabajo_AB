...
BASE_URL = "https://www.ebi.ac.uk:443/interpro/api/protein/UniProt/entry/InterPro/IPR037093/?page_size=200"
...
def output_list():
  ...
  while next:
    try:
      req = request.Request(next, headers={"Accept": "text/x-fasta"})
